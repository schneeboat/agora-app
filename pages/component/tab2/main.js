 ...
 */
   ...
   */
  loadConfig:function(){
    console.log("tab2.loadConfig");
    const db = wx.cloud.database();
    db.collection('config').get({
      success:res=>{
        this.setData({
          dinnerDate:res.data[1].dinnerDate,
          message1:res.data[1].tab2_message1,
          message2:res.data[1].tab2_message2,
          message3:res.data[1].tab2_message3,
    ...
    selectFloorNum:function(e){
      ...
      //9楼只有一个区域A，所以默认选中,如果选中其他楼层则清空区域
      if(floorNum==9){
        this.setData({
          officeArea:'a'
        })
